...
do
         ...
         ./run.slurm randomInstances/cards fouriersat unconstrained_SQUARE_GD_1.$beta10 1 square GD 0 1.$beta10 solver
         ./run.slurm randomInstances/cards fouriersat unconstrained_SQUARE_GD_0.$beta10 1 square GD 0 0.$beta10 solver
         ./run.slurm randomInstances/CNF_1000 fouriersat unconstrained_SQUARE_GD_0.$beta10 1 square GD 0 0.$beta10 dev 
         ./run.slurm randomInstances/XOR_1000 fouriersat unconstrained_SQUARE_GD_0.$beta10 1 square GD 0 0.$beta10 dev

         ./run.slurm randomInstances/cards fouriersat unconstrained_ABS_GD_1.$beta10 1 abs GD 0 1.$beta10 solver
         ./run.slurm randomInstances/cards fouriersat unconstrained_ABS_GD_0.$beta10 1 abs GD 0 0.$beta10 solver
         ./run.slurm randomInstances/CNF_1000 fouriersat unconstrained_ABS_GD_0.$beta10 1 abs GD 0 0.$beta10 dev
         ./run.slurm randomInstances/XOR_1000 fouriersat unconstrained_ABS_GD_0.$beta10 1 abs GD 0 0.$beta10 dev
done     
